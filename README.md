...
LEO=render('LOVEPREET',colors=stein_colors,align='center',font='block',background='black')
QE=render ('Telegram: @Beasteren | Join @Levixlove\nV5.0 ',colors=qe_colors,align='right',font='console',background='black')
print(LEO)
print(f'{yellow}∘₊✧───────────────────────────────────────✧₊∘                                        ')
print(QE)
print(f'{yellow}∘₊✧───────────────────────────────────────✧₊∘                                        ')
...
─✦───────────────────────✦──✦───────────────────────✦─
 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 •  ⚡ @BEASTEREN ⚡ """;inline_keyboard=[[{'text':'DEVELOPER','url':'https://t.me/beasteren'},{'text':'JOIN CHANNEL','url':'https://t.me/levixlove'}]];payload={'chat_id':user_id,'text':ss,'reply_markup':json.dumps({'inline_keyboard':inline_keyboard})}
